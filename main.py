...
def main() -> None:
    ...
    print("analysis_route:", json.dumps(result.get("analysis_route") or {}, indent=2, ensure_ascii=False))
    print("analysis_entry_result:", json.dumps(result.get("analysis_entry_result") or {}, indent=2, ensure_ascii=False))
    print("analysis_readiness:", result.get("analysis_readiness"))
