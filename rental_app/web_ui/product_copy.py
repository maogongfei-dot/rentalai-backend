...
DISPLAY_LABELS: dict[str, str] = {
    ...
    "p5_agent_section_caption": "English / 中文 / mixed. Rule-based parser (no LLM). **Continue to Analysis** runs **analyze-batch** with one scenario.",
    ...
    "p5_agent_phase_ui_submitting": "**Submitting** — running **analyze-batch** (one property).",
    ...
    "p5_agent_status_submitting": "Submitting to **analyze-batch**…",
    ...
    "p5_agent_continue_help": "Sync the property form and call **POST /analyze-batch** (one row). Works with **Use local engine**.",
    ...
    "p5_agent_spinner_submit": "Running batch analysis…",
    "p5_agent_batch_success": "**analyze-batch** finished — scroll to **Batch results** for cards, Top picks, and filters.",
